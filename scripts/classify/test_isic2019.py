#!/usr/bin/env python3
"""Evaluate a trained ISIC 2019 classifier on the test split.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ISIC 2019 classification model")
    parser.add_argument(
        "--model",
    ...
    parser.add_argument(
        ...
        help="Path to the prepared ISIC 2019 dataset root",
    )
    parser.add_argument(
        "--imgsz",
        type=int,
